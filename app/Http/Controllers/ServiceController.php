...
class ServiceController extends Controller
{
    ...
    public function filter(Request $request)
    {
        ...
        $filter_category = $request->get('sub_category_id');
        ...
        } elseif ($filter_category != null) {
            $services = Service::with('subCategory')->whereIn('sub_category_id', $filter_category)->with('area.city', 'subCategory.category')->orderby('created_at', 'DESC')->get();
            return view('visitors.filter', compact('services'));
        } elseif ($filter_area != null) {
