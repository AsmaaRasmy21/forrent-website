...
<main class="main">
    ...
    <div class="page_content bg-image mb-2 pb-8 pt-md-12 pb-md-12 pt-lg-6 pb-lg-6" style="background-image: url({{asset('assets/images/backgrounds/login-bg.jpg')}});">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-md-3 product mx-5 py-5">
                        <div class="contact-box text-center text">
                            ...
                            <div><i class="icon icon-phone" style="font-size: 25px !important; ">
                                <a href="tel:{{$info->phone}}"><span style=" direction: ltr !important; unicode-bidi: embed;">{{$info->phone}}</span></a></i>
                        </div>
                        </div><!-- End .contact-box -->
                    </div><!-- End .col-md-3 -->
                    <div class="col-md-3 product mx-5 py-5">
                        <div class="contact-box text-center">
                            ...
                            <div class="text">
                                <i class="icon icon-envelope" style="font-size: 30px !important; padding-top: 1rem !important"></i><a class="mx-3 my-5" href="mailto:{{$info->email}}">{{$info->email ?? 'None'}}</a>
                            </div>
                        </div><!-- End .contact-box -->
                    </div><!-- End .col-md-3 -->
                    <div class="col-md-3 product mx-5 py-5">
                        <div class="contact-box text-center">
                            ...
                            <div class="text">
                                <i class="icon icon-map-marker" style="font-size: 25px !important;"><a >
                                    @if(App::getlocale()=='ar')
