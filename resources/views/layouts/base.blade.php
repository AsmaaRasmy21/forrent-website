                                        ...
                                        <div class="header-dropdown">
                                            ...
                                            <div class="header-menu">
                                                <ul>
                                                    ...
                                                    <li><a href="{{ route('customer.logout') }}">{{trans('site.log_out')}}</a></li> 
                                            ...
                                            <div class="header-menu">
                                                <ul>
                                                    {{-- @if(session('name') == $service_provider->name) --}}
                                                    <li><a href="{{ route('service.provider.logout') }}">{{trans('site.log_out')}}</a></li> 
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-auto col-lg-3 col-xl-3 col-xxl-2">
                            ...
                            <a href="{{route ('home')}}" class="logo mx-4 text-center">
