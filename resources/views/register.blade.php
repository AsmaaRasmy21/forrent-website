                        ...
                        <div class="tab-pane fade" id="signin-2" role="tabpanel" aria-labelledby="signin-tab-2">
                            <form method="POST" action="{{ route('service.provider.register') }}" id="form">
                                ...
                                <div class="input-control">
                                    ...
                                    <div class="row" style="display: none;" id="document" >
                                        <div class="col-md-6">
                                            ...
                                            @if ($errors->any())
                                            <small for="fname" class="error text-danger" style="font-size: 15px">{{ $errors->first('document1')}}</small> 
                                          @endif
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            @if ($errors->any())
                                            <small for="fname" class="error text-danger" style="font-size: 15px">{{ $errors->first('document2')}}</small> 
                                          @endif
                                        </div>
                                    </div>
                                </div><!-- End .form-group -->
                                <div class="input-control">
                                    ...
                                    @if ($errors->any())
                                    <small for="fname" class="error text-danger" style="font-size: 15px">{{ $errors->first('name')}}</small> 
                                  @endif
                                </div><!-- End .form-group -->
                                ...
                                <div class="row">
                                    <div class="col-sm-6 input-control">
                                        ...
                                        @if ($errors->any())
                                        <small for="fname" class="error text-danger" style="font-size: 15px">{{ $errors->first('phone')}}</small> 
                                      @endif
                                    </div><!-- End .col-sm-6 -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 input-control">
                                        ...
                                        @if ($errors->any())
                                        <small for="fname" class="error text-danger" style="font-size: 15px">{{ $errors->first('password_confirmation')}}</small> 
                                      @endif
                                    </div><!-- End .col-sm-6 -->
                                </div><!-- End .row -->
                                ...
                                <p  style="font-size: 15px; margin-top: 20px;"> {{trans('site.already')}}<a href="{{ url ('login') }}"> {{trans('site.log_in')}}</a></p> 
                                {{-- <div class="input-control">
