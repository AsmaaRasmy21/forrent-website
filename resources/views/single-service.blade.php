                    ...
                    <div class="col-md-6">
                        <div class="product-details">
                            ...
                            <div class="ratings-container">
                                <p class="ratings-text" style="color:#fcb941; font-size: 20px;">({{trans('site.review')}} : {{$services->rate->rating}} &#9734;)</p>
                            ...
                            @if($services->discount && $services->discount_period < Carbon\Carbon::now())
                                               ...
                                               <div class="product-price"> 
                                                   <span class="old-price"> <s>{{$services->price}}  @if(App::getlocale()=='ar')
                                                    ج.س
                                                    @else
                                                    SDG 
                                                    @endif</s></span>
