           ...
           @if(Session::has('error'))
            ...
            @endif
               <div class="product p-5">
                ...
                <label>{{trans('site.current_password')}}</label>
                <input type="password" class="form-control"required disabled name="password" value="{{ $service_providers->password}}" pattern=".{6,}">
    
                <label>{{trans('site.new_password')}}</label>
